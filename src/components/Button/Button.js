...
import { defaultSize, defaultVariant, } from "./Button.shared";
...
export class Button extends Component {
    ...
    render() {
        ...
        return React.createElement(ButtonBase, Object.assign({}, buttonProps), this.props.children);
    }
}
Button.defaultProps = {
    size: defaultSize,
...
export class ButtonBase extends Component {
    ...
    render() {
        const { block, children, loading, disabled, size, weight, ...rest } = this.props;
        const loadingClass = loading ? "loading" : "";
        const disabledClass = disabled ? "disabled" : "";
        const blockClass = block ? "block" : "";
        return (React.createElement(Container, Object.assign({}, rest, { className: [blockClass, loadingClass, disabledClass].join(" "), onClick: this.onClick, disabled: disabled }),
            loading && React.createElement(Spinner, { size: this.props.buttonSize }),
            typeof children === "string" ? (React.createElement(Sans, { weight: weight || "medium", size: size, style: { textAlign: "center" } }, children)) : (children)));
    }
}
